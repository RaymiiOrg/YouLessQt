...
Window {
    ...
    height: 1000
    visible: true
    title: qsTr("YouLessQt 1.0 by Remy van Elst, raymii.org. License: GNU GPLv3")
...
//                console.log("sug: " + suggestedLwValue)
    ...
    ScrollView {
        ...
        ColumnLayout {
            ...
            CollapsableCard {
                title: collapsed ? "Help (klik om uit te klappen)" : "Help (klik om in te klappen)"
...
"
            ...
            Item {
                ...
                Text {
                    anchors.fill: parent
                    text: "YouLessQt 1.0 by Remy van Elst\nLicense: GNU GPLv3"
                    color: "#bbb"
                }
            }
